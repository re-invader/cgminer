...
static struct opt_table opt_config_table[] = {
	...
	OPT_WITH_ARG("--avalon-hysteresis",
		     ...
		     "Set regulation algorithm hysteresis level"),
	OPT_WITH_ARG("--avalon-fanwait",
		     set_int_0_to_100, opt_show_intval, &opt_avalon_fanwait,
		     "Set regulation algorithm time interval"),
	OPT_WITH_ARG("--avalon-fanfactor",
		     set_int_0_to_9999, opt_show_intval, &opt_avalon_fanfactor,
		     "Set fan sense multiplier constant for non standart fans"),
	OPT_WITH_ARG("--avalon-timeoutfactor",
		     set_int_1_to_65535, opt_show_intval, &opt_avalon_timeoutfactor,
		     "Set timeout constant divided by frequency in avalon-auto"),
#endif
